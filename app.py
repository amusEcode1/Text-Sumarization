...
Original file is located at
    https://colab.research.google.com/drive/1vlrUhbcP4uBfQ1k-6QrQd_9YY07JarJm
"""

!pip install streamlit -q
!pip install transformers -q
!pip install spacy pytextrank -q
...
def load_abstractive_model():
    tokenizer = AutoTokenizer.from_pretrained("/content/drive/MyDrive/Models/Text_Summarization/summarizer_tokenizer")
    model = AutoModelForSeq2SeqLM.from_pretrained("/content/drive/MyDrive/Models/Text_Summarization/summarizer_model")
...
!jupyter nbconvert --to script "/content/drive/MyDrive/Colab Notebooks/Text_Summarization_app/app.ipynb"

!mv "/content/drive/MyDrive/Colab Notebooks/Text_Summarization_app/app.txt" "/content/drive/MyDrive/Colab Notebooks/Text_Summarization_app/app.py"
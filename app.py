...
def load_abstractive_model():
    tokenizer = AutoTokenizer.from_pretrained("amusEcode/text-summarizer-tokenizer")
    model = AutoModelForSeq2SeqLM.from_pretrained("amusEcode/text-summarizer-model")
